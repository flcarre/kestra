...
class McpServerChangeNotifierTest {
    ...
    void givenActiveServer_whenServerIsDeleted_thenServerIsEvicted() throws DeserializationException {
        ...
        notifier.handleMcpChange(buildMcpServer(serverId, true, true));
    ...
    private static McpServer buildMcpServer(String id, boolean enabled, boolean deleted) {
        return new McpServer(null, id, null, null, null, null, enabled, false, deleted, null, null);
    }
}
