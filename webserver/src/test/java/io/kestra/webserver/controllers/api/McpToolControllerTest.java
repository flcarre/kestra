...
class McpToolControllerTest {
    ...
    void givenEnabledServerWithInstructions_whenInitialize_thenSessionCreatedWithServerInfo() {
        ...
        String serverId = saveServer(true, instructions);
    ...
    private String saveServer(boolean enabled, String instructions) {
        String serverName = "server-" + IdUtils.create();
        McpServer mcpServer = new McpServer(TenantService.MAIN_TENANT, serverName,
            "A test MCP server", instructions, null, null, enabled, false, false, null, null);
