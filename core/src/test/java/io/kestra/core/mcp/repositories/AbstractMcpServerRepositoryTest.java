...
public abstract class AbstractMcpServerRepositoryTest {
    ...
    void givenExistingMcpWhenUpdateThenChangesPersistedAndCreatedPreserved() {
        ...
        McpServer updated = new McpServer(tenant,
            original.id(), "Updated description", null, null, null, false, false, false, null, null);
    ...
    void givenMultipleMcpsWhenListThenAllReturned() {
        ...
        // When
        ArrayListTotal<McpServer> results = mcpServerRepository.list(Pageable.from(1, 10), tenant);
    ...
    void givenMcpsAcrossTenantsWhenListThenOnlyCurrentTenantReturned() {
        ...
        // When / Then
        assertThat(mcpServerRepository.list(Pageable.from(1, 10), tenant1).size()).isEqualTo(1);
        assertThat(mcpServerRepository.list(Pageable.from(1, 10), tenant2).size()).isEqualTo(1);
    }
    ...
    void givenExistingDefaultServer_whenEnsureDefault_thenIdempotent() {
        ...
        ArrayListTotal<McpServer> results = mcpServerRepository.list(Pageable.from(1, 100), tenant);
    ...
    private static McpServer createMcpServer(String tenantId) {
        ...
        return new McpServer(tenantId, id, "A test MCP server", null, null, null, true, false, false, null, null);
    }
}
